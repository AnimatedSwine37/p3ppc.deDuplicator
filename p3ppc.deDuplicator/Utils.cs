using p3ppc.deDuplicator.Configuration;
using Reloaded.Memory.SigScan.ReloadedII.Interfaces;
using Reloaded.Mod.Interfaces;
using System.Diagnostics;
using System.Text;

namespace p3ppc.deDuplicator;
...
internal class Utils
{
    ...
    internal static void LogDebug(string message)
    {
        if (_config.DebugEnabled)
            _logger.WriteLine($"[De-Duplicator] {message}");
    }
    ...
    {
        _logger.WriteLine($"[De-Duplicator] {message}: {e.Message}", System.Drawing.Color.Red);
    }

    internal static void LogError(string message)
    {
        _logger.WriteLine($"[De-Duplicator] {message}", System.Drawing.Color.Red);
    }
